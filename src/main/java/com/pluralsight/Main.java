...
public class Main {
    ...
    public static void main(String[] args){
        ...
        vehicleQuantity = 6;    //first time quantity of vehicles is assigned
        ...
        private static void findVehiclesByMakeModel() {
            String makeModelToSearchFOr = ConsoleHelper.promptForString("Enter make/model to search for");
        ...
        private static void displayVehicle (v){
